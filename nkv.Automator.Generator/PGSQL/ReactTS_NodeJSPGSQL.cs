...
{
    public class ReactTS_NodeJSPGSQL
    {
        ...
        public ReactTS_NodeJSPGSQL(string projectName, string destinationFolder, string destinationFolderSeparator)
        {
            DestinationFolder = destinationFolder;
            ProjectName = projectName;
            ExList = new List<Exception>();
            TemplateFolder = "PGSQL_ReactTsNodeJSTemplate";
                ...
                try
                {
                    ...
                    foreach (var f in r.Value)
                    {
                        ...
                        else if (f.functionType == "getbyid")
                        {
                            ...
                            foreach (var pKey in tableData.PrimaryKeys)
                            {
                                primaryKeyCommaString = primaryKeyCommaString+ pKey.FieldName + ",";
                            }
                            primaryKeyCommaString = primaryKeyCommaString.Trim(',');
