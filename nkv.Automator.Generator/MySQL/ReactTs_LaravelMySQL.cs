...
{
    public class ReactTs_LaravelMySQL
    {
        ...
        public ReactTs_LaravelMySQL(string projectName, string destinationFolder, string destinationFolderSeparator)
        {
            DestinationFolder = destinationFolder;
            ProjectName = projectName;
            ExList = new List<Exception>();
            TemplateFolder = "ReactTsLaravelTemplate";
